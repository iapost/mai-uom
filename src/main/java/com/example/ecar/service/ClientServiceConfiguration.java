...
public class ClientServiceConfiguration implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		cService.addDealership(d1);
		cService.addDealership(d2);
		cService.addDealership(d3);
		cService.addDealership(d4);
		...
		cService.addCar(car1);
		cService.addCar(car2);
		cService.addCar(car3);
		cService.addCar(car4);
		cService.addCar(car5);
		cService.addCar(car6);
		cService.addCar(car7);
		cService.addCar(car8);
		cService.addCar(car9);
		cService.addCar(car10);
		cService.addCar(car11);
		cService.addCar(car12);
